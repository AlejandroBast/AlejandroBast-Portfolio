  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          >
            <p className="mb-4 text-lg leading-8 text-white/65">
              ¿Tienes un proyecto en mente, una propuesta de trabajo o simplemente quieres ponerte en contacto?
            </p>
            <p className="mb-12 text-lg leading-8 text-white/65">
              Estoy disponible para roles freelance y posiciones full-time. No dudes en escribirme.
            </p>
            ...
            <div className="space-y-4">
              {socials.map((s, i) => (
                ...
                >
                  ...
                  <svg className="ml-auto text-white/25" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div>
                    ...
                    <input name="name" value={form.name} onChange={handleChange} required placeholder="Tu nombre" className="contact-input" />
                  </div>
                  <div>
                    <label className="mb-2 block text-xs uppercase tracking-widest text-white/35">Email</label>
                    <input type="email" name="email" value={form.email} onChange={handleChange} required placeholder="tu@email.com" className="contact-input" />
                  </div>
                </div>
                <div>
                  <label className="mb-2 block text-xs uppercase tracking-widest text-white/35">Mensaje</label>
                  <textarea name="message" value={form.message} onChange={handleChange} required rows={6} placeholder="Cuéntame sobre tu proyecto..." className="contact-input resize-none" />
                </div>
      ...
      <style jsx>{`
        ...
        .submit-btn:hover:not(:disabled) { opacity: 0.9; transform: scale(1.01); }
