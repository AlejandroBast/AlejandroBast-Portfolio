...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "project.4.title": "Minecraft Server Manager",
    "project.4.desc": "Aplicación que democratiza la creación y administración de servidores de Minecraft: elimina la complejidad técnica de configurar, arrancar y mantener un servidor.",
    "project.5.title": "NotyWhats",
    "project.5.desc": "Automatiza el envío de recordatorios de citas médicas por WhatsApp tomando los datos directamente desde un archivo de Excel.",
    "project.6.title": "Eventix",
    "project.6.desc": "Plataforma de eventos: publicación, venta de entradas con pago simulado, generación de códigos QR, validación de accesos, dashboards y exportación de reportes.",
    ...
    "contact.fallback": "¿Sigue fallando? Escríbeme directamente por correo →",
  ...
  en: {
    ...
    "project.4.title": "Minecraft Server Manager",
    "project.4.desc": "An app that democratizes running Minecraft servers: it removes the technical complexity of configuring, launching, and maintaining a server.",
    "project.5.title": "NotyWhats",
    "project.5.desc": "Automates medical appointment reminders over WhatsApp, pulling the data straight from an Excel spreadsheet.",
    "project.6.title": "Eventix",
    "project.6.desc": "Event platform: publishing, ticket sales with simulated payment, QR code generation, access validation, dashboards, and report exports.",
    ...
    "contact.fallback": "Still failing? Email me directly →",
